...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/nestjs.md](https://github.com/meeymirita/lab-fixes/blob/main/nestjs.md) репозитория `lab-fixes`.
